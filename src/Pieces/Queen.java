...
public class Queen extends Piece {
	...
	if (Board.inBound(newLocRow, newLocCol) && Board.inBound(origLocRow, origLocCol)) {
		...
		if (Board.isEmpty(newLocRow, newLocCol) && (newLocRow == origLocRow && ((newLocCol == origLocCol + 1)
			|| (newLocCol == origLocCol + 2) || (newLocCol == origLocCol + 3)
			|| (newLocCol == origLocCol + 4) || (newLocCol == origLocCol + 5)
			|| (newLocCol == origLocCol + 6) || (newLocCol == origLocCol + 7)))) {
		...
		if (Board.isEmpty(newLocRow, newLocCol) && (newLocCol == origLocCol && ((newLocRow == origLocRow + 1)
			|| (newLocRow == origLocRow + 2) || (newLocRow == origLocRow + 3)
			|| (newLocRow == origLocRow + 4) || (newLocRow == origLocRow + 5)
			|| (newLocRow == origLocRow + 6) || (newLocRow == origLocRow + 7)))) {
