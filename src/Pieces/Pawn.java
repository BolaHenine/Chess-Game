...
public class Pawn extends Piece {
	...
	public boolean enPassant(String move)
	{
		...
		if(!Board.isBlack(origLocRow, origLocCol) && origLocRow==3 && newLocRow == origLocRow-1 && (newLocCol == origLocCol-1 || newLocCol == origLocCol+1))
		{
		...
		else if(Board.isBlack(origLocRow, origLocCol) && origLocRow==4 && newLocRow == origLocRow+1 && (newLocCol == origLocCol-1 || newLocCol == origLocCol+1))
		{
